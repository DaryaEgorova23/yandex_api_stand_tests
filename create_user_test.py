...
def positive_assert(first_name):
    ...
    assert user_response.json()["authToken"] != ""cC:\Users\Darya\PycharmProjects\yandex_api_stand_testsC:\Users\Darya\PycharmProjects\yandex_api_stand_tests
...
def negative_assert(first_name):
    ...
    # Проверяется, что в ответе атрибут code — 400
